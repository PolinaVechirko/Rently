...
namespace Rently.Persistence.Migrations
{
    ...
    [Migration("20260522140119_RemoveParentReviewId")]
    partial class RemoveParentReviewId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rently.Domain.Entities.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Rently.Domain.Entities.AvailabilityBlock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Rently.Domain.Entities.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Rently.Domain.Entities.Favorite", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Rently.Domain.Entities.Photo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("AccommodationId", "SortOrder");

                    b.ToTable("Photos");
                });

            modelBuilder.Entity("Rently.Domain.Entities.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Rently.Persistence.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Rently.Domain.Entities.Accommodation", b =>
                {
                    b.HasOne("Rently.Domain.Entities.Address", "Address")
                        .WithMany("Accommodations")
                        .HasForeignKey("AddressId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Rently.Domain.Entities.Photo", "CoverPhoto")
                        .WithMany()
            ...
            modelBuilder.Entity("Rently.Domain.Entities.AccommodationAmenity", b =>
                {
                    b.HasOne("Rently.Domain.Entities.Accommodation", "Accommodation")
                        .WithMany("AccommodationAmenities")
                        .HasForeignKey("AccommodationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Rently.Domain.Entities.Amenity", "Amenity")
                        .WithMany("AccommodationAmenities")
